...
const features = [
  ...
  },
  {
    ...
    desc: "Финская сауна и турецкий хаммам для полноценного отдыха и восстановления",
  },
  {
    icon: TreePine,
      ...
      <section className="section-padding max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection>
          <SectionHeader
            ...
            subtitle="Комплекс Усадьба VIP предлагает полный спектр услуг для незабываемого отдыха на черноморском побережье"
          />
        </AnimatedSection>
